...
nyc_longs <- nyc$LONGITUDE
nyc_lats <- nyc$LATITUDE
nyc$round_location <- paste("(", round(nyc_lats, digits = 4), ", ", 
                            round(nyc_longs, digits = 4), ")", sep = "")
...
<<echo=FALSE, message=FALSE, warning=FALSE>>=
# preprocessing 1
twitter_train <- read.csv("~/Documents/STAT405_605/STAT605_Project/c3xvj5snvv-1/1_TrainingSet_3Class.csv", header=FALSE)
twitter_test <- read.csv("~/Documents/STAT405_605/STAT605_Project/c3xvj5snvv-1/1_TestSet_3Class.csv", header=FALSE)
