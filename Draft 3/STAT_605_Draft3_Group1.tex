...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `\$<-.data.frame`(`*tmp*`, AV\_VEH\_AGE, value = numeric(0)): replacement has 0 rows, data has 2205618}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'as.data.frame': object 'prop\_table1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'prop\_df' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'prop\_df' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `combine\_vars()`:\\\#\# ! Faceting variables must have at least one value.}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `mutate()`:\\\#\# i In argument: `location = sapply(tweet\_text, extract\_location)`.\\\#\# Caused by error in `str\_detect()`:\\\#\# ! could not find function "{}str\_detect"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'tweet\_type\_summary' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unnest\_tokens(., word, tweet\_text): could not find function "{}unnest\_tokens"{}}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'twitter\_borough' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'borough\_comparison' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'select': object 'borough\_comparison' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'borough\_comparison\_long' not found}}\end{kframe}
\end{knitrout}
