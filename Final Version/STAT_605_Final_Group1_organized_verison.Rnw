...
ggplot(hourly_proportions, aes(x = HOUR, y = prop, fill = covid_period)) + 
  ...
  labs(title = "Proportional Crash Distribution by Hour Across COVID Periods",
...
<<echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=12, fig.align='center'>>=
