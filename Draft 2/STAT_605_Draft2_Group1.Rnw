...
nyc$round_location <- paste("(", round(nyc_lats, digits = 4), ", ", round(nyc_longs, digits = 4), ")", sep = "")
=======
...
sp_limits <- read.csv(file = "Project/data/speed_limits.csv")
...
>>>>>>> ee0e2a9 (updated intro and dataset description)
@
